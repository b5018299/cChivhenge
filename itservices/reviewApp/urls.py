...
from .views import ProductListingView, PostDetailView, ProductReviewsListView, CreateReview, UpdateReview, DeleteReview
...
urlpatterns =[
	...
	path('product/', ProductListingView.as_view(), name='product'),
